...
public class MenucDTO {
	 ...
	 int calorias;
	 double precio;
	public MenucDTO(int tipo_menu,String tm_nombre, String nombre_menu, String lista_ingredientes, int calorias, double precio) {
		super();
