...
public class MenuvgaDTO {
	 ...
	 int calorias;
	 double precio;
	public MenuvgaDTO(int tipo_menu,String tm_nombre, String nombre_menu, String lista_ingredientes, int calorias, double precio) {
		super();
	...
	public MenuvgaDTO(int tipo_menu) {
		this.tipo_menu = tipo_menu;
	}
